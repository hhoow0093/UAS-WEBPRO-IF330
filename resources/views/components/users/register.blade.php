                    ...
                    <div class="row gap-4">
                        <div class="col-12">
                            <div class="logo d-flex justify-content-between gap-2 align-items-center">
                                ...
                                <h2 class="fw-bold my-auto d-flex align-items-center header text-end" style="height: 30px; color:#125A95;">REGISTER PAGE</h2>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12 text-center">
                            <a href="{{ route('login') }}"><button type="submit" class="btn container-fluid text-white" style="background-color: #125A95;">Already have an account? Login here</button></a>
                        </div>
                    </div>
                </div>
            </div>
