<section class="footer-seader" style="overflow: hidden;">
    <footer class="row  border-top align-items-center p-4">
        <div class=" col-12 col-md-6 mb-3 ms-2">
          ...
          </svg></span> Scientia Residences, Jl. Scientia Square Utara, Curug Sangereng, Kelapa Dua, Kab. Tangerang, Banten</p>
          ...
          </svg></span> info@seadex.co.id</p>
          <p><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-window-fullscreen" viewBox="0 0 16 16">
          ...
          </svg></span> +62 812 9930 1290</p>
        </div>
  
        <div class=" col-12 col-md-4 mb-3 ms-2 ms-md-0">
          <h3 style="color: rgb(5, 89, 158);">Sitemap</h3>
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="/seadex/home" class="nav-link p-0 text-body-secondary">Home</a></li>
            <li class="nav-item mb-2"><a href="/seadex/services" class="nav-link p-0 text-body-secondary">Services</a></li>
