<x-layout>
    ...
    <x-slot:title>Halaman services</x-slot:title>
    ...
    <section class="product-page-header text-white py-5" style="background-color: rgb(5, 89, 158);">
        <div class="container">
            <h1 class="text-center mb-4 montserrat">Our Products<span style="text-decoration-line: underline; text-decoration-color: #ffff; text-decoration-thickness: 5px; text-underline-offset: 10px;">oduc</span>ts</h1>
                    ...
                    <div class="col-12 col-md-4 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <a href="deleteCategory/{{ $category->id }}/" class="btn btn-sm btn-outline-danger mt-2">Delete</a>
                            </div>
                        </div>
                    </div>
                @endforeach
