<x-layout>
    ...
    <section class="product-page-header text-white py-5" style="background-color: rgb(5, 89, 158);">
        <div class="container">
            <h1 class="text-center mb-4 montserrat">Our Pr<span style="text-decoration-line: underline; text-decoration-color: #ffff; text-decoration-thickness: 5px; text-underline-offset: 10px;">oduc</span>ts</h1>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <h4 class="card-title font-semiboldlora text-[35px]">Coffee Products</h4>
                            <p class="card-text roboto text-[18px]">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <h4 class="card-title font-semiboldlora text-[35px]">Health Supplements</h4>
                            <p class="card-text roboto text-[18px]">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <h4 class="card-title font-semiboldlora text-[35px]">Agricultural Commodities</h4>
                            <p class="card-text roboto text-[18px]">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4 class="card-title font-semiboldlora text-[35px]">Green Coffee Beans Arabica</h4>
                            <p class="card-text roboto text-[18px]">
                ...
                <div class="col-12 col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4 class="card-title font-semiboldlora text-[35px]">Green Coffee Beans Robusta</h4>
                            <p class="card-text roboto text-[18px]">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <h4 class="card-title font-semiboldlora text-[35px]">Herbal Extracts</h4>
                            <p class="card-text roboto text-[18px]">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <h4 class="card-title font-semiboldlora text-[35px]">Nutritional Supplements</h4>
                            <p class="card-text roboto text-[18px]">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <h4 class="card-title font-semiboldlora text-[35px]">Wellness Products</h4>
                            <p class="card-text roboto text-[18px]">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <h4 class="card-title font-semiboldlora text-[35px]">Spices and Herbs</h4>
                            <p class="card-text roboto text-[18px]">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <h4 class="card-title font-semiboldlora text-[35px]">Tropical Fruits</h4>
                            <p class="card-text roboto text-[18px]">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <h4 class="card-title font-semiboldlora text-[35px]">Sustainable Crops</h4>
                            <p class="card-text roboto text-[18px]">
