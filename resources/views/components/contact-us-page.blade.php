        ...
        <section class="section">
            <div class="background">
                <div class="content">
                    ...
                    <h4 id="want">Want to get in touch? We'd Love to hear from you. Here's how you can reach us
                    </h4>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 d-flex align-items-center justify-content-center gap-2">
                        <form action="{{ route('contact.submit') }}" method="POST" class="container-fluid">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group mt-3">
                                        <label for="name" class="fw-bold">Name <span
                                ...
                                <div class=" col-12 col-md-6">
                                    <div class="form-group mt-3">
                                        <label for="email" class="fw-bold">Email Adress <span
                                                style="color: red;">*</span></label>
                            ...
                            <div class="form-group mt-3">
                                <label for="company_name" class="fw-bold">Company name <span
                                        style="color: red;">*</span></label>
                            ...
                            <div class="form-group mt-3">
                                <label for="phone_number" class="fw-bold">Phone Number <span
                                        style="color: red;">*</span></label>
                            ...
                            <div class="form-group mt-3">
                                <label for="country" class="fw-bold">Country <span
                                        style="color: red;">*</span></label>
                            ...
                            <div class="form-group mt-3">
                                <label for="inquiry_type" class="fw-bold">Inquiry Type <span
                                        style="color: red;">*</span></label>
                            ...
                            <div class="form-group mt-3">
                                <label for="inquiry_details" class="fw-bold">Inquiry_details <span
                                        style="color: red;">*</span></label>
                                <textarea class="form-control" id="inquiry_details" name="inquiry_details" rows="4" required>{{ old('inquiry_details') }}</textarea>
